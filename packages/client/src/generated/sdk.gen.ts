...
/**
 * Update API key role, name, or permissions
 */
export const patchV1AuthKeysId = <ThrowOnError extends boolean = false>(options: Options<PatchV1AuthKeysIdData, ThrowOnError>) => (options.client ?? client).patch<PatchV1AuthKeysIdResponses, PatchV1AuthKeysIdErrors, ThrowOnError>({
    security: [{ scheme: 'bearer', type: 'http' }],
    url: '/v1/auth/keys/{id}',
    ...options,
    headers: {
 ...
 */
export const postV1SessionsIdApprovalApprove = <ThrowOnError extends boolean = false>(options: Options<PostV1SessionsIdApprovalApproveData, ThrowOnError>) => (options.client ?? client).post<PostV1SessionsIdApprovalApproveResponses, PostV1SessionsIdApprovalApproveErrors, ThrowOnError>({
    security: [{ scheme: 'bearer', type: 'http' }],
 ...
 */
export const postV1SessionsIdApprovalReject = <ThrowOnError extends boolean = false>(options: Options<PostV1SessionsIdApprovalRejectData, ThrowOnError>) => (options.client ?? client).post<PostV1SessionsIdApprovalRejectResponses, PostV1SessionsIdApprovalRejectErrors, ThrowOnError>({
    security: [{ scheme: 'bearer', type: 'http' }],
...
/**
 * Server-side budget enforcement status
 *
 * Returns whether server-side budget enforcement is enabled and what limits are configured. Dashboard uses this to show appropriate warnings when enforcement is not active.
 */
export const getV1SettingsBudget = <ThrowOnError extends boolean = false>(options?: Options<GetV1SettingsBudgetData, ThrowOnError>) => (options?.client ?? client).get<GetV1SettingsBudgetResponses, unknown, ThrowOnError>({
    security: [{ scheme: 'bearer', type: 'http' }],
...
/**
 * Quick approve permission request (dashboard inline button)
 */
export const postV1SessionsIdPermissionApprove = <ThrowOnError extends boolean = false>(options: Options<PostV1SessionsIdPermissionApproveData, ThrowOnError>) => (options.client ?? client).post<PostV1SessionsIdPermissionApproveResponses, PostV1SessionsIdPermissionApproveErrors, ThrowOnError>({
    security: [{ scheme: 'bearer', type: 'http' }],
...
/**
 * Quick reject permission request (dashboard inline button)
 */
export const postV1SessionsIdPermissionReject = <ThrowOnError extends boolean = false>(options: Options<PostV1SessionsIdPermissionRejectData, ThrowOnError>) => (options.client ?? client).post<PostV1SessionsIdPermissionRejectResponses, PostV1SessionsIdPermissionRejectErrors, ThrowOnError>({
    security: [{ scheme: 'bearer', type: 'http' }],
