...
export function registerOpenApiSpec(): void {
  ...
  registerOpenApiPath({
    ...
    parameters: [
      ...
      { name: 'sessionId', in: 'query', required: false, schema: z.string(), description: 'Filter by Aegis session ID' },
      { name: 'claudeSessionId', in: 'query', required: false, schema: z.string(), description: 'Filter by Claude Code session ID (CLAUDE_CODE_SESSION_ID)' },
