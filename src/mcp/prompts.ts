        ...
        messages: [
          {
            ...
            content: {
              ...
              text: [
                ...
                `3. Get terminal debug output using acp_get_terminal_debug for session ${safeSessionId}`,
                ...
                '',
                'Use get_status, get_transcript, and acp_get_terminal_debug tools to gather data.',
              ].join('\n'),
            },
          },
        ],
