...
export const en = {
  ...
  cost: {
    ...
    '30days': '30 Days',
    '90days': '90 Days',
    sessionsRunningNoCost: 'Sessions are running but no cost data yet',
    costWillAppear: 'Cost data will appear as sessions consume tokens',
    costLabel: 'Cost over {days} days',
    costLabelShort: 'Cost',
    last7DaysAvg: 'Last 7 days avg',
    vsAvg: 'vs avg ({pct})',
    projectedMonth: 'Projected this month',
    daysPastRemaining: '{passed} days past, {remaining} remaining',
    dailySpendDays: 'Daily spend ({count} days)',
    costAnalyticsTitle: 'Cost Analytics',
    burnRatePerHour: 'Burn rate: {rate}/hr',
  ...
  audit: {
    ...
    auditTrailSubtitle: 'Query admin audit events with chain-integrity verification',
  ...
  metrics: {
    ...
    anomalyDescription: 'Keys with unusual spike in session count',
  ...
  authKeys: {
    ...
    publicAccessTitle: 'API keys disabled in zero-config mode',
    publicAccessDescription: 'This dashboard is running without authentication, so API key management is unavailable.',
    publicAccessCreateDisabled: 'Start Aegis with authentication enabled to create and revoke dashboard API keys.',
    revoke: 'Revoke',
    revoking: 'Revoking…',
  ...
  newSession: {
    ...
    workDirDescription: 'Absolute path where the session will run, for example /home/user/project or C:\\Users\\you\\project',
    workDirPlaceholder: '/home/user/project or C:\\Users\\you\\project',
    ...
    workDirAbsolute: 'Working directory must be an absolute path, for example /home/user/project or C:\\Users\\you\\project',
