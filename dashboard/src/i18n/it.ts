...
export const it = {
  ...
  authKeys: {
    ...
    publicAccessTitle: 'Chiavi API disabilitate in modalità zero-config',
    publicAccessDescription: 'Questa dashboard è in esecuzione senza autenticazione, quindi la gestione delle chiavi API non è disponibile.',
    publicAccessCreateDisabled: 'Avvia Aegis con autenticazione abilitata per creare e revocare chiavi API della dashboard.',
    revoke: 'Revoca',
  ...
  newSession: {
    ...
    workDirDescription: 'Percorso assoluto dove verrà eseguita la sessione, per esempio /home/utente/progetto o C:\\Users\\you\\project',
    workDirPlaceholder: '/home/utente/progetto o C:\\Users\\you\\project',
    ...
    workDirAbsolute: 'La directory di lavoro deve essere un percorso assoluto, per esempio /home/utente/progetto o C:\\Users\\you\\project',
