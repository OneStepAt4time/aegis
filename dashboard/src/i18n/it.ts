...
export const it = {
  ...
  overview: {
    ...
    loadingMetrics: 'Caricamento metriche panoramica...',
    metricsUnavailable: 'I widget usano gli ultimi dati disponibili.',
    ...
    avgPermissionLatency: 'Latenza Media Permessi',
    avgChannelLatency: 'Latenza Media Canale',
    totalEstCost: 'Costo Stimato Totale',
    sentTotal: '{n} inviati totali',
    failedCount: '{n} falliti',
    zeroFailed: '0 falliti',
    metricsUnavailableShort: 'Endpoint metriche non disponibile — valori segnaposto.',
  ...
  sessionDetail: {
    ...
    tokensTotal: '{n} token totali',
    considerCheaperModel: '· considera un modello più economico',
    ...
    tokenType: 'Tipo',
    tokenCount: 'Conteggio',
    inputTokens: 'Input',
    outputTokens: 'Output',
    cacheCreate: 'Cache Create',
    cacheRead: 'Cache Read',
    costDisclaimer: 'Il costo usa i listini Anthropic (tier sonnet predefinito). Il costo effettivo può variare.',
    permissionRequiredToast: 'Permesso richiesto: {name}',
