        ...
        <form onSubmit={handleBatchSubmit} className="p-4 sm:p-5 space-y-4">
          ...
          <div>
            ...
            <textarea
              ...
              rows={2}
className="w-full min-h-[66px] px-3 py-2.5 text-sm bg-[var(--color-void)] border border-[var(--color-void-lighter)] rounded text-[var(--color-text-primary)] placeholder:text-[var(--color-placeholder)] focus-visible:outline-none focus:border-[var(--color-cta-bg)] resize-none"
            />
          </div>
