        ...
        <form onSubmit={handleSubmit} className="p-4 sm:p-5 space-y-4">
          ...
          <div className="flex gap-2 pt-2">
            <button
              ...
              onClick={handleClose}
              disabled={loading}
              className="flex-1 min-h-[44px] px-3 py-2 text-xs font-medium rounded bg-[var(--color-void)] border border-[var(--color-void-lighter)] text-gray-300 hover:text-gray-100 hover:border-[var(--color-void-lighter)] transition-colors disabled:opacity-50" // token-ok
            >
              Cancel
            </button>
            <button
